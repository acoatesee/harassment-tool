...
const HarassmentNext = {
    ...
    outputMultipleComplaints: {default: 'discussion'},
    discussion: { 0: "outputInvestigationConfidentiality", default: "inWorkplace" },
    outputInvestigationConfidentiality: { default: 'inWorkplace'},
    ...
    outputUnionSameRepConsent: { default: "unionLocation" },
    unionLocation: { 6: "outputUnionLocation", default: "invOrganizer" },
    outputUnionLocation: { default: "invOrganizer" },
